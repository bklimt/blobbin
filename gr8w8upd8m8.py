...
# This file comes from: http://www.stavros.io/posts/your-weight-online/
# And this repo: https://github.com/skorokithakis/gr8w8upd8m8
# It was licensed under the LGPL.
# It has been modified slightly to make it callable from another script,
# and to make it call another script with the result.
...
def main(argv):
    ...
    storage.save_weight(processor.weight)
